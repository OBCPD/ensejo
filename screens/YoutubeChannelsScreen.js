...
const YoutubeChannelsScreen = props => {
    ...
    const renderI = dataI =>{
        ...
        return(
            <Youtube name = {dataI.item.title} link = {dataI.item.link} desc = {dataI.item.description} />
        );
    }
    useEffect(()=>{
...
YoutubeChannelsScreen.navigationOptions = navData => {
    return{
