...
const SigninCourseScreen = props => {
    ...
    const submitHandler = () =>{
        if(title === '' || desc === '' || link === ''){
            ...
            fetch('https://my-test-esejo-app-default-rtdb.firebaseio.com/registers/course.json',{
                    method: 'POST',
                    headers: {
...
SigninCourseScreen.navigationOptions = navData => {
    return{
...
export default SigninCourseScreen;