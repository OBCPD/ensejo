...
const SigninCulturalScreen = props => {
    ...
    const submitHandler = () =>{
        if(title === '' || desc === '' || link === ''){
            ...
            fetch('https://my-test-esejo-app-default-rtdb.firebaseio.com/registers/cultural.json',{
                    method: 'POST',
                    headers: {
...
SigninCulturalScreen.navigationOptions = navData => {
    return{
...
export default SigninCulturalScreen;