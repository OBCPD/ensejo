...
const SigninDonationScreen = props => {
    ...
    const submitHandler = () =>{
        if(title === '' || desc === '' || link === ''){
            ...
            fetch('https://my-test-esejo-app-default-rtdb.firebaseio.com/registers/donation.json',{
                    method: 'POST',
                    headers: {
...
SigninDonationScreen.navigationOptions = navData => {
    return{
...
export default SigninDonationScreen;