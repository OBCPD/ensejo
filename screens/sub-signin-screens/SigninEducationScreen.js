...
const SigninEducationScreen = props => {
    ...
    const submitHandler = () =>{
        if(title === '' || desc === '' || link === '' || tags === []){
            ...
            fetch('https://my-test-esejo-app-default-rtdb.firebaseio.com/registers/education.json',{
                    method: 'POST',
                    headers: {
...
SigninEducationScreen.navigationOptions = navData => {
    return{
...
export default SigninEducationScreen;